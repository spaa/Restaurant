...
<div id="header">
  ...
  <div id="company_name">Dwarka Restaurant</div>
</div>
<div id="center">

  <h1>ABOUT Dwarka</h1>
  <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
  <p>Dwarka is a multinational restaurant food chain and delivery service with an aim of providing nutritious food to all our current and esteemed customers in Kenya and the world. This is achieved through quality services that surpases customers' satisfaction.</p>
