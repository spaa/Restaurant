...
//Select database
$db = mysqli_select_db(DB_DATABASE) || 'rms';
if(!$db) {
...
<title>Dwarka Restaurant:Home</title>
        ...
        <td style="text-align:center;">
            ...
            <form id="loginForm" name="loginForm" method="post" action="login-exec.php" onsubmit="return loginValidate(this)">
              <table width="290" border="0" align="center" cellpadding="2" cellspacing="0">
                <tr>
                    <h><td colspan="2" style="text-align:center;"><font color="#FF0000"> </font><h1>Login Form</h1></td>
                </tr>
                <tr>
                ...
                <tr>
				  ...
				  <a href="Register.php">Register Form</a></td>
                </tr>
                <tr><td>&nbsp;</td></tr>
              </table>
            </form>
